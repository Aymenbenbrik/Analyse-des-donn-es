...
\column{0.49\textwidth}
\begin{prop}[Trace et déterminant]
\[
...
\begin{rema}[Conséquence majeure]
...
\begin{rema}[Importance pour l'ACP]
...
\begin{prop}[Forme dyadique / SVD réduite]
\[
...
\begin{rema}[Interprétation pour l'analyse des données]
...
\begin{prop}[Pourcentage d'inertie expliquée]
